...
PYTHONPATH=. .venv/bin/python -m src.x_deepagents "<q>" --run
"""
...
def test_reuse_boundary_resolves_backend():
    from src.x_deepagents.reuse import AppConfig, load_prompt
...
def test_reused_tool_classes_importable():
    from src.x_deepagents.reuse import (
...
def test_hello_agent_constructs():
    from src.x_deepagents.agents.hello import make_hello_agent
