...
from src.agents.graph import DecomposeError
...
def test_decompose_parses_valid_plan(monkeypatch):
    from src.agents.agents.stages import decompose_requirements
...
def test_decompose_node_raises_decompose_error_not_single_task(monkeypatch):
    ...
    from src.agents.graph import decompose_node

    from src.agents.state import Phase, RunBudget, XDeepRunState
    ...
    monkeypatch.setattr("src.agents.agents.stages.make_orchestrator",
