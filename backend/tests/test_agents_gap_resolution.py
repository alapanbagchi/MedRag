...
def test_compute_gaps_lists_unsatisfied_requirements():
    from src.agents.agents.gap_fill import compute_gaps
...
def test_gap_resolution_closes_via_local_retrieval(monkeypatch):
    ...
    from src.agents.agents import gap_fill as gf
    ...
    monkeypatch.setattr("src.agents.agents.worker._local_retrieve",
                        _fake_local([hits[0]]))
    monkeypatch.setattr("src.agents.agents.stages.verify_item",
                        _fake_verify)
    async def _plan(*a, **k):
        return ["new query"]
    monkeypatch.setattr("src.agents.agents.gap_fill._plan_gap_queries",
                        _plan)
...
def test_gap_resolution_lists_when_unresolved(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.agents.tools.searxng.searxng_search_impl", _empty_web)
...
def test_gap_resolution_web_closes_when_local_empty(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.agents.tools.searxng.searxng_search_impl", _web_hit)
    monkeypatch.setattr("src.agents.agents.stages.judge_site_reliability",
...
def test_satisfied_requirement_still_probes_latent_gaps(monkeypatch):
    ...
    monkeypatch.setattr("src.agents.agents.gap_fill._probe_latent_gaps",
                        _probe_gaps)
    monkeypatch.setattr("src.agents.agents.stages.verify_item", _fake_verify)
    monkeypatch.setattr("src.agents.agents.worker._local_retrieve", _fake_local)
    monkeypatch.setattr("src.agents.tools.searxng.searxng_search_impl", _fake_web)
    async def _rel(*a, **k):
        return {"reliability": "high"}
    monkeypatch.setattr("src.agents.agents.stages.judge_site_reliability", _rel)
    monkeypatch.setattr("src.agents.agents.gap_fill._gap_completeness_check",
                        _complete_gate)
...
def test_web_fires_even_when_local_closes_the_gap(monkeypatch):
    ...
    monkeypatch.setattr("src.agents.agents.gap_fill._probe_latent_gaps", _probe_gaps)
    monkeypatch.setattr("src.agents.agents.stages.verify_item", _fake_verify)
    monkeypatch.setattr("src.agents.agents.worker._local_retrieve", _fake_local)
    monkeypatch.setattr("src.agents.tools.searxng.searxng_search_impl", _fake_web)
    monkeypatch.setattr("src.agents.agents.gap_fill._gap_completeness_check", _complete_gate)
    async def _rel(*a, **k):
        return {"reliability": "high"}
    monkeypatch.setattr("src.agents.agents.stages.judge_site_reliability", _rel)
...
def test_web_augmentation_on_no_probe_gaps(monkeypatch):
    ...
    monkeypatch.setattr("src.agents.agents.gap_fill._probe_latent_gaps", _no_gaps)
    monkeypatch.setattr("src.agents.agents.stages.verify_item", _fake_verify)
    monkeypatch.setattr("src.agents.agents.worker._local_retrieve", _fake_local)
    monkeypatch.setattr("src.agents.tools.searxng.searxng_search_impl", _fake_web)
    monkeypatch.setattr("src.agents.agents.stages.judge_site_reliability",
...
def test_web_evidence_uses_fetched_page_text(monkeypatch):
    ...
    monkeypatch.setattr("src.agents.agents.gap_fill._probe_latent_gaps", _page)
    monkeypatch.setattr("src.agents.agents.stages.verify_item", _verify)
    monkeypatch.setattr("src.agents.agents.worker._local_retrieve", _fake_local)
    monkeypatch.setattr("src.agents.tools.searxng.searxng_search_impl", _fake_web)
    monkeypatch.setattr("src.agents.agents.gap_fill._gap_completeness_check", _complete_gate)
    async def _rel(*a, **k):
...
def test_gate_marks_partially_resolved_with_remaining_facets(monkeypatch):
    ...
    from src.agents.agents import gap_fill as gf
    from src.agents.agents.gap_fill import resolve_requirement_gaps
    from src.agents.state import GapResolutionStatus
    ...
    monkeypatch.setattr("src.agents.agents.worker._local_retrieve", _fake_local)
    monkeypatch.setattr("src.agents.tools.searxng.searxng_search_impl", _fake_web)
    monkeypatch.setattr("src.agents.agents.gap_fill._gap_completeness_check", _partial)
...
def test_synthesis_reconciles_unresolved_gaps_into_run(monkeypatch):
    ...
    from src.agents.state import GapResolution
...
def test_fallback_synthesize_grounds_answer_in_evidence():
    from src.agents.agents.stages import fallback_synthesize
...
def test_synthesize_with_data_falls_back_when_agent_raises(monkeypatch):
    ...
    from src.agents.agents.stages import synthesize_answer_with_data
