...
from src.x_deepagents.bridge import _cited_text, _doc_to_index
...
def test_web_source_url_carries_text_fragment():
    ...
    from src.x_deepagents.bridge import _src, _text_fragment_url
...
def test_web_source_dict_exposes_highlight_and_isWeb():
    ...
    from src.x_deepagents.bridge import _src
...
def test_synthesize_prompt_tells_resolved_contradictions_inline():
    ...
    from src.x_deepagents.agents.stages import _synthesize_prompt
