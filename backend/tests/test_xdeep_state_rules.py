...
from src.x_deepagents.rules import (
    RuleViolation,
...
def test_meaningfully_different_drops_exact_repeats():
    from src.x_deepagents.agents.stages import meaningfully_different
...
def test_sanitize_strips_boolean_operators():
    from src.x_deepagents.agents.stages import _sanitize_semantic_query
...
def test_semantic_queries_dedup_and_limit():
    from src.x_deepagents.agents.stages import _semantic_queries
