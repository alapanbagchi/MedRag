...
def test_registry_wires_expected_tools():
    from src.x_deepagents.tools import all_tools, get, selectable, tools_for_agent
...
def test_langchain_tool_shape():
    from src.x_deepagents.tools.postgres_search import postgres_search
    from src.x_deepagents.tools.retrieve import retrieve
...
def test_postgres_search_degrades_when_pg_unreachable(monkeypatch):
    ...
    from src.x_deepagents.tools.postgres_search import postgres_search, reset_pg_store
...
def test_postgres_search_reports_empty_corpus(monkeypatch):
    ...
    from src.x_deepagents.tools import postgres_search as ps_mod
    from src.x_deepagents.tools.postgres_search import postgres_search, reset_pg_store
...
def test_tool_set_attaches_to_deep_agent():
    ...
    try:
        from src.x_deepagents.config import build_chat_model
