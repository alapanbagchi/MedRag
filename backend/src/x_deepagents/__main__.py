"""python -m src.x_deepagents "question" - research CLI.
...
def main() -> int:
    ...
    from src.x_deepagents.graph import _new_run, build_research_graph, progress
    from src.x_deepagents.logging import close_run_log, log_path, open_run_log
...
async def _stream_run(graph, question: str):
    ...
    from src.x_deepagents.graph import _new_run, progress
