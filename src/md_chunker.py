...
Consumes the ``.md`` files produced by ``scripts/jats_to_md.py`` (YAML front
...
no flags needed):
    python -m src.md_chunker --input data/md --chunks-out chunks_v2
"""
...
from src.models import CHUNK_VERSION, Chunk
...
def _attach_table_context(blocks: List[RawBlock]) -> None:
    ...
    after a table) produced by scripts/jats_to_md.py."""
