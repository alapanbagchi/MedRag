...
from src.retrieval_v2.pageindex_stage.config import StageConfig, config_from_env
from src.retrieval_v2.pageindex_stage.cache import (
    is_cached,
    load_tree,
    save_tree,
)
from src.retrieval_v2.pageindex_stage.models import NavigationError, PaperDocument
...
def build_index(paper_id: str, markdown_path: Optional[Path] = None,
    ...
    if not md_path.exists():
        from src.retrieval_v2.pageindex_stage.models import TREE_LOAD_ERROR
    ...
    try:
        ...
        from src.retrieval_v2.pageindex_stage.models import PAGEINDEX_CLIENT_ERROR
