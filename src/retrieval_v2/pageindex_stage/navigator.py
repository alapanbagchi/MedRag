...
from src.retrieval_v2.pageindex_stage.indexer import _leaves_and_paths, build_index
from src.retrieval_v2.pageindex_stage.models import (
...
def verify_medgemma_endpoint(config: Optional[StageConfig] = None) -> Dict[str, Any]:
    ...
    """
    from src.retrieval_v2.pageindex_stage.models import MEDGEMMA_ENDPOINT_ERROR
    import requests
