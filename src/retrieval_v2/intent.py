...
from src.retrieval_v2.models import EvidenceCandidate, Requirement
from src.retrieval_v2.table_context import requested_field_fraction
    ...
    for req in requirements:
        ...
        for c in pool:
            ...
            if c.detected_fields:
                ...
                from src.retrieval_v2.table_context import detect_paragraph_fields
