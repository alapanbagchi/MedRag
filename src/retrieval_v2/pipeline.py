...
def load_components(
    ...
    from src.trace import TraceLogger as _TraceLogger
    from src.trace import set_trace
    ...
    from src.retrieval.corpus import CORPUS_FILENAME
...
def run_v2_pipeline(
    ...
    if isinstance(plan, V2Plan):
        ...
        from src.retrieval_v2.planner import plan_from_dict
        ...
        if cfg.llm_planning in ("decompose", "enrich") and cfg.llm_base_url:
            ...
            try:
                from src.retrieval_v2.llm_planner import call_expand, plan_from_expand
        ...
        if v2_plan is None and cfg.llm_planning == "decompose" and components.llm is not None:
            ...
            try:
                from src.retrieval_v2.llm_planner import structured_plan_with_llm
    ...
    from src.retrieval_v2.retriever import GlobalRetriever
    t0 = time.perf_counter()
    ...
    from src.retrieval_v2.paper_select import aggregate_papers, select_papers
    t0 = time.perf_counter()
    ...
    from src.retrieval_v2.local_search import LocalRetriever
    t0 = time.perf_counter()
    ...
    from src.retrieval_v2.rerank import RequirementReranker
    t0 = time.perf_counter()
    ...
    from src.retrieval_v2.intent import score_intent
    ...
    from src.retrieval_v2.select import greedy_select
    t0 = time.perf_counter()
    ...
    from src.retrieval_v2.select import repair_uncovered
    ...
    from src.retrieval_v2.select import build_coverage_report
    ...
    from src.retrieval_v2.evaluator import evaluate_run
