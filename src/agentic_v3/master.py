...
ROBUST DECOMPOSITION (accommodates strict/verbose master prompts):
  ...
  The system prompt lives in src/prompts/agentic_v3/master.txt and may be
...
MASTER_SYSTEM_PROMPT = load_prompt("agentic_v3", "master.txt")

logger = logging.getLogger("src.agentic_v3.master")
...
def first_json(raw: str, output_type: Any) -> Optional[Any]:
    ...
    """
    from src.lib import _extract_json_objects, strip_think
