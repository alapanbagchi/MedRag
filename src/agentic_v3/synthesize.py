...
from src.agentic_v3.state import ResolutionStatus, V3RunState

logger = logging.getLogger("src.agentic_v3.synthesize")
...
SYNTHESIS_SYSTEM_PROMPT = load_prompt('agentic_v3', 'synthesize.txt')
