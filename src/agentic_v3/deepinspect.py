...
from src.agentic_v3.critic import CriticAgent, evidence_excerpt
...
logger = logging.getLogger("src.agentic_v3.deepinspect")
...
INSPECTOR_SYSTEM_PROMPT = load_prompt('agentic_v3', 'deep_inspector.txt')
    ...
    async def inspect(
        ...
        *,
        ...
        for f in findings:
            ...
            from src.agentic_v3.state import EvidenceStatus, RetrievedPaper
