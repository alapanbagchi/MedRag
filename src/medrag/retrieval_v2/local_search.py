...
from medrag.retrieval_v2.document_index import TABLE_TYPES, tokens
from medrag.retrieval_v2.expand import expand_anchors
from medrag.retrieval_v2.models import EvidenceCandidate, Requirement, SearchQuery
from medrag.retrieval_v2.retriever import NullTrace, rrf_fuse
...
class LocalRetriever:
    ...
    def search_requirement_targeted(
        ...
        qs = list(queries or [])
        if not qs:
            from medrag.retrieval_v2.models import SearchQuery as _SQ
