...
export function AgUiSidebar() {
  ...
  return (
    <aside className="hidden h-full w-[260px] shrink-0 flex-col px-3 py-4 md:flex">
      <div className="flex items-center gap-2.5 px-2 pb-5">
        <img src="/favicon.svg" alt="MedRAG" className="size-8 rounded-[10px] shadow-[0_4px_14px_rgba(75,140,245,0.35)]" />
        <span className="text-[17px] font-semibold tracking-tight text-foreground">MedRAG</span>
      ...
      <div className="mt-2 flex items-center gap-2.5 rounded-full px-2 py-2">
        <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#4b8cf5] to-[#9d7bfb] text-[11px] font-semibold text-white">
          M
        </span>
