...
const Shell = ({ children }: { children: React.ReactNode }) => (
 <div className="anim-rise my-1 overflow-hidden rounded-xl border border-border bg-card ">
 {children}
 </div>
);
...
export const ErrorCard: DataMessagePartComponent<Data> = ({ data }) => (
 <div className="my-1 rounded-xl border border-danger/25 bg-danger/10 px-4 py-2.5 text-[13px] text-danger">
