...
function Calendar({
 ...
 months: clsx("relative flex flex-col gap-4 md:flex-row", defaultClassNames.months),
 ...
 dropdown: clsx("absolute inset-0 opacity-0", defaultClassNames.dropdown),
 caption_label: clsx(
 ...
 if (orientation === "left") {
 return <ChevronLeftIcon className={clsx("size-4", className)} {...props} />;
 }

 if (orientation === "right") {
 return <ChevronRightIcon className={clsx("size-4", className)} {...props} />;
 }
