...
export const STEP_META: Record<string, StepMeta> = {
  retrieve: { label: "Document retrieval", icon: SearchIcon, tone: "text-[#4b8cf5]" },
  umls: { label: "UMLS Expansion", icon: LanguagesIcon, tone: "text-[#4b8cf5]" },
  web_search: { label: "Web search", icon: GlobeIcon, tone: "text-[#18AE95]" },
  web_fetch: { label: "Fetching source", icon: ExternalLinkIcon, tone: "text-[#4b8cf5]" },
  reliability: { label: "Reliability check", icon: ShieldCheckIcon, tone: "text-[#18AE95]" },
  verdict: { label: "Evidence verdict", icon: ScaleIcon, tone: "text-amber-500" },
  decompose: { label: "Decomposing the question", icon: NetworkIcon, tone: "text-[#4b8cf5]" },
  research: { label: "Research task", icon: FlaskConicalIcon, tone: "text-[#4b8cf5]" },
  search_round: { label: "Search round", icon: RefreshCwIcon, tone: "text-[#4b8cf5]" },
  contradiction: { label: "Contradiction", icon: AlertTriangleIcon, tone: "text-amber-500" },
  resolution: { label: "Resolved", icon: CheckIcon, tone: "text-[#18AE95]" },
  gap_check: { label: "Gap agent", icon: ScanSearchIcon, tone: "text-[#4b8cf5]" },
  delegate: { label: "Delegation", icon: UserPlusIcon, tone: "text-[#4b8cf5]" },
  gap_probe: { label: "Evidence gap", icon: TargetIcon, tone: "text-amber-500" },
  gap_resolution: { label: "Gap resolved", icon: PuzzleIcon, tone: "text-[#18AE95]" },
  evidence: { label: "Verified evidence", icon: DatabaseIcon, tone: "text-[#4b8cf5]" },
  synthesize: { label: "Synthesizing answer", icon: PenLineIcon, tone: "text-[#4b8cf5]" },
  planner: { label: "Planning", icon: RouteIcon, tone: "text-[#4b8cf5]" },
  join: { label: "Joining findings", icon: GitMergeIcon, tone: "text-[#4b8cf5]" },
